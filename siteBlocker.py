...
user_input = input("Would you like to add or remove a site from your host file? ")
...
def add_site():
    ...
    with open('/etc/hosts', 'r') as file:
        ...
        while result:
            file.seek(0)
            user_input_add = input("Site is already being blocked. What site would you like to block?: ")
            result = re.search(rf'\b{user_input_add}\b', lines)
        else:
